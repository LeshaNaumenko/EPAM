public class TemperatureConverter {
    ...
    public static void main(String[] args) {
        System.out.println(new TemperatureConverter().convertFtoC(10.1));
        System.out.println(new TemperatureConverter().convertCtoF(10.1));
        System.out.println(new TemperatureConverter().convertCtoK(10.1));
        System.out.println(new TemperatureConverter().convertKtoC(10.1));
        System.out.println(new TemperatureConverter().convertFtoK(10.1));
        System.out.println(new TemperatureConverter().convertKtoF(10.1));
    }
}
